...
class Resume1:
    def __init__(self, name, email, number):
        ...
        self.doc = Document(documentclass="resume", geometry_options=borders, page_numbers=False)
    ...
    def addExtracurriculars(self, activities):
        self.doc.append(Command("begin", ["rSection", "Extracurricular Activities"]))
...
#     resume.doc.generate_tex("./resume_test")
#     resume.doc.generate_pdf("testpdf", compiler="/Library/TeX/texbin/pdflatex")
